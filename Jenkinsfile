pipeline {
    ...
    environment {
        ...
        ECR_REPO = '460425808763.dkr.ecr.us-east-1.amazonaws.com/my_pvt_repo' // Your ECR repository URI
    ...
    stages {
        stage('SCM checkout') {
            steps {
                script {
                    git branch: 'main', credentialsId: 'git-cred', url: 'https://github.com/dineshdini909-cpu/K8s_Real_Project/tree/main'
                }
            }
        }
